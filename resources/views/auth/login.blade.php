...
<aside>
    <div class="layout-login d-flex justify-content-center align-items-center p-5 container col-6" >
        <div class="login-section p-5" style="border-radius: 10px; border: 1px solid white;">
