...
@section('content')
    <div class="main-div">
        ...
        <div class="menu-header container p-3">
            ...
            <a href="/food/view/{{ $item->id }}"><li>{{ $item->name }}</li></a>
        ...
        <div class="food-item container">
            ...
            <div class="starter-img">
                ...
                {{-- <img src="{{ asset('storage/images/'.$item->categoryImage->image->path) }}"  alt="{{ $item->name }}" ><br> --}}
                {{-- <img src="{{ asset('storage/images/1696033262.rollls-cat.png' ) }}"  alt="{{ $item->name }}" style="width: 10rem; height:auto; border-radius:8px;"><br> --}}
            </div>
        </div>
        {{-- @endforeach --}}
        {{-- <div class="food-item container">
